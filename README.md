...
A text classification system that scrapes book data, trains a genre classifier, and serves predictions through a REST API — built with reproducibility as a core requirement: pinned dependencies, fixed random seeds, automated testing, and containerized.
